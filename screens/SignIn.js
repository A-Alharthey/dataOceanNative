...
import { View, Text, StyleSheet, TextInput, StatusBar, Pressable, Image, KeyboardAvoidingView, Platform, ScrollView } from 'react-native';
...
export default function SignIn() {
    ...
    return (
        <KeyboardAvoidingView keyboardVerticalOffset={useHeaderHeight()} behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1, backgroundColor: '#282C34' }}>
            <StatusBar barStyle={"light-content"} />
            <ScrollView contentContainerStyle={{ flex: 1, justifyContent: 'center', alignItems: 'center', padding: 20,marginBottom:"25%"}}>
